...
[![Codecov test coverage](https://codecov.io/gh/EzequielPiseri/datacities/graph/badge.svg)](https://app.codecov.io/gh/EzequielPiseri/datacities)
<!-- badges: end -->

# Introduccion

`datacities` es un paquete que incluye un dataset interno de ciudades y funciones
para explorarlo de forma simple.
